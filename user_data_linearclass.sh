...
if [ $VOLUME_ID ]; then
        ...
        rm -rf ~/anaconda3/envs/amazonei*
        rm -rf ~/anaconda3/envs/caffe*
        rm -rf ~/anaconda3/envs/tensorflow*
        rm -rf ~/anaconda3/envs/mxnet*
        rm -rf ~/anaconda3/envs/cntk*
...
#		sudo -H -u ubuntu bash -c "source /home/ubuntu/anaconda3/bin/activate tensorflow_p36; python ec2_spot_keras_training.py"
		sudo -H -u ubuntu bash -c "source /home/ubuntu/anaconda3/bin/activate pytorch_p27; ./eval_linear_spot.sh"
fi
